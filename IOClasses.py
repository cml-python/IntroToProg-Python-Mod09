...
# cleung,6.14.2020, pasted listing 11 into IOClasses
# ---------------------------------------------------------- #
...
class EmployeeIO:
    ...
    def input_employee_data():
        ...
        try:
            ...
            first_name = str(input("Enter Employee First Name: ").strip())
            last_name = str(input("Enter Employee Last Name: ").strip())
            print()  # Add an extra line for looks
